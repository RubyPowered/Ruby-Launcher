...
public class WorldBackup extends Thread{

	private final String pathToGameFolder = System.getProperty("user.home")+"\\AppData\\Roaming\\.minecraft\\saves";
	
	private final String newZipFolder = System.getProperty("user.home")+"\\Desktop\\MCWorldsBackup.mcworldpack";
